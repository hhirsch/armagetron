...
static const yytype_uint8 yyprhs[] =
{
      ...
      27,    31,    34,    38,    43,    47,    48,    50
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      23,     0,    -1,    24,    -1,     3,    -1,     4,    -1,    25,
      -1,    24,     6,    24,    -1,    24,     7,    24,    -1,    24,
       8,    24,    -1,    24,     9,    24,    -1,    24,    16,    24,
      -1,     7,    24,    -1,    19,    24,    20,    -1,     5,    19,
      26,    20,    -1,    25,    18,    25,    -1,    -1,    24,    -1,
      26,    21,    24,    -1
};
...
{
       0,    55,    55,    81,    86,    91,    92,    96,   100,   104,
     108,   112,   117,   125,   133,   137,   140,   145
};
#endif
...
{
  "$end", "error", "$undefined", "tINTEGER", "tSTRING", "tID", "'+'",
  "'-'", "'*'", "'/'", "tNE", "tEQ", "tGT", "tLT", "tGE", "tLE",
  "tCOMPARE", "tUNARYMINUS", "'.'", "'('", "')'", "','", "$accept",
  "input", "expr", "function", "arglist", 0
};
#endif
...
#line 82 "vParser.ypp"
    {
		(yyval.expr) = new Expr::Int((yyvsp[(1) - (1)].integer));
	  }
    break;
...
#line 87 "vParser.ypp"
    {
		(yyval.expr) = new Expr::String(*(yyvsp[(1) - (1)].string));
...
#line 93 "vParser.ypp"
    {
		(yyval.expr) = new Expr::Math::Add(BasePtr((yyvsp[(1) - (3)].expr)), BasePtr((yyvsp[(3) - (3)].expr)));
	  }
    break;
...
#line 97 "vParser.ypp"
    {
		(yyval.expr) = new Expr::Math::Subtract(BasePtr((yyvsp[(1) - (3)].expr)), BasePtr((yyvsp[(3) - (3)].expr)));
	  }
    break;
...
/* Line 1806 of yacc.c  */
#line 101 "vParser.ypp"
    {
		(yyval.expr) = new Expr::Math::Multiply(BasePtr((yyvsp[(1) - (3)].expr)), BasePtr((yyvsp[(3) - (3)].expr)));
	  }
    break;
...
/* Line 1806 of yacc.c  */
#line 105 "vParser.ypp"
    {
		(yyval.expr) = new Expr::Math::Divide(BasePtr((yyvsp[(1) - (3)].expr)), BasePtr((yyvsp[(3) - (3)].expr)));
	  }
    break;
...
/* Line 1806 of yacc.c  */
#line 109 "vParser.ypp"
    {
		(yyval.expr) = new Expr::Comparison::Compare(BasePtr((yyvsp[(1) - (3)].expr)), BasePtr((yyvsp[(3) - (3)].expr)));
	  }
    break;
...
/* Line 1806 of yacc.c  */
#line 113 "vParser.ypp"
    {
		static BasePtr zero(new Expr::Int(0));
		(yyval.expr) = new Expr::Math::Subtract(zero, BasePtr((yyvsp[(2) - (2)].expr)));
	  }
    break;
...
/* Line 1806 of yacc.c  */
#line 126 "vParser.ypp"
    {
		std::vector<tString> flags;
		flags.push_back(tString("func"));
		(yyval.expr) = Registry::Registry::theRegistry().create(flags, *(yyvsp[(1) - (4)].string), *(yyvsp[(3) - (4)].arglist));
...
/* Line 1806 of yacc.c  */
#line 141 "vParser.ypp"
    {
		(yyval.arglist) = new arglist();
		(yyval.arglist)->push_back(BasePtr((yyvsp[(1) - (1)].expr)));
	  }
    break;
...
/* Line 1806 of yacc.c  */
#line 146 "vParser.ypp"
    {
		(yyval.arglist) = (yyvsp[(1) - (3)].arglist);
		(yyval.arglist)->push_back(BasePtr((yyvsp[(3) - (3)].expr)));
	  }
    break;
